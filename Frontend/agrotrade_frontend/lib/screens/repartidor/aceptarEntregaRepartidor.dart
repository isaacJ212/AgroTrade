...
class _AceptarEntregaRepartidorState extends State<AceptarEntregaRepartidor> {
              ...
              children: [
                ...
                RepartidorCard(
                  ...
                  child: CheckboxListTile(
                    ...
                    subtitle: const Text(
                      'Confirma que puedes recoger los productos.',
                    ),
                  ),
                ),
  ...
  Future<void> _aceptar(RepartidorDemo demo, int pedidoId) async {
    setState(() => _guardando = true);
    try {
      await demo.aceptarEntrega(pedidoId);
      if (!mounted) return;
      Navigator.pushReplacement(
        context,
        MaterialPageRoute<void>(
          builder: (_) => RecogerPedidoRepartidor(pedidoId: pedidoId),
        ),
      );
