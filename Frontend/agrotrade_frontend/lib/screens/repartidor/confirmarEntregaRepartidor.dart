...
class _ConfirmarEntregaRepartidorState
  ...
  Widget build(BuildContext context) {
    ...
    final entrega = widget.pedidoId == null
        ? demo.activa
        : demo.buscar(widget.pedidoId);
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        ...
                        style: RepartidorTextStyles.label,
                      ),
                ...
                RepartidorBoton(
                  ...
                  onPressed:
                      ...
                      ? null
                      : () {
                          _confirmarEntrega(demo, entrega.id);
                        },
                ),
                const SizedBox(height: 12),
                const Text(
  ...
  Future<void> _confirmarEntrega(RepartidorDemo demo, int pedidoId) async {
    setState(() => _guardando = true);
    try {
      await demo.confirmarEntrega(pedidoId, _nota.text);
      if (!mounted) return;
