...
class DashboardView {
  constructor() {
    this.container = document.getElementById('screen-resumen');
  }
    ...
    container.innerHTML = pending.map(item => {
      ...
      return `
        <div class="applicant-review-card">
          ...
          <button class="btn-primary" onclick="router.navigateTo('revisar-verificacion', { idSolicitud: ${item.idSolicitud} })">
