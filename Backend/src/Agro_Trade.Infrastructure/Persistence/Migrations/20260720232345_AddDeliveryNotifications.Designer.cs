...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.Conversacion", b =>
                {
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.ConversacionParticipante", b =>
                {
                    b.Property<int>("IdConversacion")
                        .HasColumnType("integer")
                        .HasColumnName("id_conversacion");
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.ImpactoSocial", b =>
                {
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.InventarioProveedor", b =>
                {
                    b.Property<int>("IdInventario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.LogisticaEntrega", b =>
                {
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.Mensaje", b =>
                {
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.Permiso", b =>
                {
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.Producto", b =>
                {
                    b.Property<int>("IdProducto")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.Rol", b =>
                {
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.SolicitudRepartidor", b =>
                {
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.UsuarioRol", b =>
                {
                    b.Property<int>("IdUsuario")
                        .HasColumnType("integer")
                        .HasColumnName("id_usuario");
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.Valoracion", b =>
                {
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.ConversacionParticipante", b =>
                {
                    b.HasOne("Agro_Trade.Domain.Entities.Conversacion", "Conversacion")
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.ImpactoSocial", b =>
                {
                    b.HasOne("Agro_Trade.Domain.Entities.DetallePedido", "DetallePedido")
                        .WithOne("ImpactoSocial")
                        .HasForeignKey("Agro_Trade.Domain.Entities.ImpactoSocial", "IdDetallePedido")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("Agro_Trade.Domain.Entities.Proveedor", "Proveedor")
                        .WithMany("ImpactosSociales")
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.InventarioProveedor", b =>
                {
                    b.HasOne("Agro_Trade.Domain.Entities.Producto", "Producto")
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.Mensaje", b =>
                {
                    ...
                    b.HasOne("Agro_Trade.Domain.Entities.Usuario", "Emisor")
                        .WithMany()
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.Producto", b =>
                {
                    b.HasOne("Agro_Trade.Domain.Entities.Categoria", "Categoria")
                        .WithMany("Productos")
            ...
            modelBuilder.Entity("Agro_Trade.Domain.Entities.RolPermiso", b =>
                {
                    b.HasOne("Agro_Trade.Domain.Entities.Permiso", "Permiso")
                    ...
                    b.HasOne("Agro_Trade.Domain.Entities.Rol", "Rol")
                        .WithMany("RolesPermisos")
                        .HasForeignKey("IdRol")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
