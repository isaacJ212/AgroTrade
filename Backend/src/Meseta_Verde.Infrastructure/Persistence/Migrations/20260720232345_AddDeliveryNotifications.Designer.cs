...
namespace Meseta_Verde.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260720232345_AddDeliveryNotifications")]
    partial class AddDeliveryNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Meseta_Verda.Domain.Entities.Repartidor", b =>
                {
                    ...
                    b.Property<decimal>("PromedioCalificacion")
                        .HasColumnType("numeric")
                        .HasColumnName("promedio_calificacion");
            ...
            modelBuilder.Entity("Meseta_Verda.Domain.Entities.SolicitudRepartidor", b =>
                {
                    ...
                    b.Property<DatosRepartidorDto>("DatosRepartidor")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("datos_repartidor");
                    ...
                    b.HasKey("IdSolicitud")
                        .HasName("pk_solicitud_repartidor");

                    b.HasIndex("IdUsuario")
                        .HasDatabaseName("ix_solicitud_repartidor_id_usuario");

                    b.ToTable("solicitud_repartidor", (string)null);
                });
            ...
            modelBuilder.Entity("Meseta_Verda.Domain.Entities.Valoracion", b =>
                {
                    ...
                    b.HasIndex("IdProveedor")
                        .HasDatabaseName("ix_valoraciones_id_proveedor");
            ...
            modelBuilder.Entity("Meseta_Verda.Domain.Entities.SolicitudRepartidor", b =>
                {
                    b.HasOne("Meseta_Verda.Domain.Entities.Usuario", "Usuario")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_solicitud_repartidor_usuarios_id_usuario");
            ...
            modelBuilder.Entity("Meseta_Verda.Domain.Entities.Valoracion", b =>
                {
                    ...
                    b.HasOne("Meseta_Verda.Domain.Entities.Proveedor", "Proveedor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_valoraciones_proveedores_id_proveedor");

                    b.HasOne("Meseta_Verda.Domain.Entities.Usuario", "UsuarioCliente")
                        .WithMany("ValoracionesRealizadas")
                        .HasForeignKey("IdUsuarioCliente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
